...
var categories = ["Surf", "Plongée", "Snow", "Randonnée"];
var forfaits = [
    {
        id: "forfait_1",
    ...
    {
        nom: "Ski de fond à Tremblant - Québec",
        categorie: "Snow",
        description: "Le produit 1 bla bla bla...",
        duree: 9,
    ...
    {
        nom: "Ski hors piste à Sälen - Suède",
        categorie: "Snow",
        description: "Le produit 1 bla bla bla...",
        duree: 7,
        debut_saison: "2016-12-01",
    ...
    {
        nom: "Chien de traineau en Vanoise - France",
        categorie: "Snow",
        description: "Le produit 1 bla bla bla...",
        duree: 8,
        debut_saison: "2016-12-15",
    ...
    {
        nom: "Volcans et pyramides Mayas - Guatemala",
        categorie: "Randonnée",
        description: "Le produit 1 bla bla bla...",
        duree: 15,
